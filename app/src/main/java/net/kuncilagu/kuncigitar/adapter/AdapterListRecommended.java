...
public class AdapterListRecommended extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<RecommendedSongModel> items = new ArrayList<>();
    ...
    public AdapterListRecommended(Context context, List<RecommendedSongModel> items) {
        this.items = items;
        ctx = context;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            final RecommendedSongModel p = items.get(position);
    ...
    private void onMoreButtonClick(final View view, final RecommendedSongModel p) {
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, RecommendedSongModel obj, int pos);
    }

    public interface OnMoreButtonClickListener {
        void onItemClick(View view, RecommendedSongModel obj, MenuItem item);
    }
